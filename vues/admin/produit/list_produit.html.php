<h1>Admin - Produits de la <?php echo $produits[0]->categorieTitre; ?></h1>
<hr>
...
<table class="table table-striped">
    ...
    <?php foreach ($produits as $donnee): ?>
        <?php if ($donnee->publier == 0) : ?>
            ...
            <td>
                <a href="?page=admin_produit&action=update&id=<?php echo $donnee->idprod; ?>&categorie_id=<?php echo $produits[0]->categorie_id; ?>"><button type="button" class="btn btn-warning">Editer</button></a>
